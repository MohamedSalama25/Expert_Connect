        ...
        <AuthLayout>
            ...
            <div className="space-y-6">
                ...
                <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                    <div className="space-y-2 relative">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="py-6 ltr:pl-10 rtl:pr-10 rounded-xl bg-[var(--ec-surface-container-low)] border-none focus-visible:ring-[var(--ec-primary)]/30 transition-shadow"
                            />
                        </div>
                    </div>
                    ...
                    <Button className="w-full py-6 rounded-xl signature-gradient text-white font-black text-base shadow-lg hover:shadow-xl active:scale-[0.98] transition-all mt-4 group">
                        {t.auth.signInButton}
