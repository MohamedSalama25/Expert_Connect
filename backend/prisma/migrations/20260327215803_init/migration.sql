...
-- AddForeignKey
ALTER TABLE "ExpertCategory" ADD CONSTRAINT "ExpertCategory_expertId_fkey" FOREIGN KEY ("expertId") REFERENCES "ExpertProfile"("userId") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Availability" ADD CONSTRAINT "Availability_expertId_fkey" FOREIGN KEY ("expertId") REFERENCES "ExpertProfile"("userId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BookingSlot" ADD CONSTRAINT "BookingSlot_expertId_fkey" FOREIGN KEY ("expertId") REFERENCES "ExpertProfile"("userId") ON DELETE CASCADE ON UPDATE CASCADE;
