            ...
            <nav className="flex flex-col h-full py-2 space-y-1">
                ...
                <div className="mt-auto pb-8 space-y-1">
                    ...
                    <button
                        ...
                        className={cn(
                            "flex items-center font-semibold text-sm transition-all text-red-500 hover:bg-red-50/50 mt-1",
                            isCollapsed ? "justify-center mx-3 py-3 rounded-xl" : "gap-3 ltr:pl-8 rtl:pr-8 py-3 w-full"
                        )}
                    >
                        <LogOut className="w-5 h-5 flex-shrink-0" />
                        {!isCollapsed && <span className="truncate">{t.auth.logout}</span>}
                    </button>
                </div>
            </nav>
        </aside>
