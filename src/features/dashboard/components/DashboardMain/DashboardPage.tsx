                    ...
                    <Card className="col-span-1 lg:col-span-5 border-none signature-gradient text-white relative overflow-hidden">
                        <CardContent className="p-8 relative z-10 flex flex-col h-full">
                            ...
                            <div className="mt-auto pt-6 border-t border-white/20">
                                ...
                                <Button className="mt-6 w-full py-4 bg-white text-[var(--ec-primary)] rounded-xl font-black shadow-xl active:scale-95 transition-transform h-auto hover:bg-white/90">
                            ...
                            <Card className="bg-card ambient-shadow border border-border hover:bg-muted transition-colors">
                                <CardContent className="p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <Button className="px-6 py-2 signature-gradient text-white rounded-lg text-sm font-bold shadow-md opacity-90 hover:opacity-100 transition-opacity">
                                            {t.common.joinRoom}
                                        </Button>
                                    </div>
                                </CardContent>
